...
def run_suite(failures, n_ok):
    with sync_playwright() as pw:
        ...
        page.click("#modalBox [data-mtab='play']"); page.wait_for_timeout(150)
        ...
        page.click("#modalBox [data-mtab='board']"); page.wait_for_timeout(150)
        ...
        page.click("#modalBox [data-mtab='look']"); page.wait_for_timeout(150)
        ...
        page.click("#modalBox [data-mtab='sound']"); page.wait_for_timeout(150)
