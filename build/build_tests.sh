...
# paridade NNUE C++ vs Python). Sem -march=native/AVX2: são testes de
# corretude/precisão numérica, não de performance. Equivalente Linux de
# build_tests.bat.
set -euo pipefail
