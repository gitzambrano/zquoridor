...
static Options parseArgs(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (a == "--lazy-wall-gen") o.lazyWallGeneration = true;
...
int main(int argc, char** argv) {
    ...
    if (opt.lazyWallGeneration) params.lazyWallGeneration = true;
    ...
    while (std::getline(std::cin, line)) {
        ...
        if (cmd == "uci") {
            ...
            std::cout << "info depth " << stats.reachedDepth
                      ...
                      << " lazyWall=" << (params.lazyWallGeneration ? 1 : 0)
                      << " lazyChecks=" << mstats.lazyWallChecks
                      << " lazyAccept=" << mstats.lazyWallAccepted
                      << " lazyReject=" << mstats.lazyWallRejected
