...
static Options parseArgs(int argc, char** argv) {
    ...
    for (int i = 1; i < argc; ++i) {
        ...
        else if (a == "--graph-tt") o.graphTT = true;
...
int main(int argc, char** argv) {
    ...
    if (opt.graphTT) params.graphTT = true;
    ...
    while (std::getline(std::cin, line)) {
        ...
        if (cmd == "uci") {
            ...
            std::cout << "info depth " << stats.reachedDepth
                      ...
                      << " graphTT=" << (params.graphTT ? 1 : 0)
                      << " graphProbe=" << mstats.graphTTProbes
                      << " graphHit=" << mstats.graphTTHits
                      << " graphMerge=" << mstats.graphTTMerges
                      << " graphCycleReject=" << mstats.graphTTCycleRejects << "\n";
