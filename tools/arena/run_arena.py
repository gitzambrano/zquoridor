...
GIT_REF2 = "main"               # 2026-08-26: os DOIS engines rodam o mesmo código local de
...
MCAB_VALUE_KNOBS = [
    ...
    ("mcab-graph-leaf-mix", "mcab_graph_leaf_mix", None, None, float),
...
MCAB_FLAG_KNOBS = [
    ...
    ("mcab_graph_qcorr",          None, None, "mcab-graph-qcorr", "no-mcab-graph-qcorr"),
...
E1_WEIGHTS_DIR = "data/nnue/nnue_weights_int8.bin"
